...
TEST_CASES = {
    ...
    'eddies_12mesh_2mpi': {
        'input': 'dancing_eddies_12mesh_2mpi.fds',
        'chid': 'dancing_eddies_12mesh_2mpi',
        'meshes': 12,
        'mpi_processes': 2,
        'description': '12-mesh eddies with 2 MPI processes (6 per rank)',
        'compare_files': [],
        'timeout': 120,
    },
    'eddies_22mesh_2mpi': {
        'input': 'dancing_eddies_22mesh_2mpi.fds',
        'chid': 'dancing_eddies_22mesh_2mpi',
        'meshes': 22,
        'mpi_processes': 2,
        'description': '22-mesh eddies with 2 MPI processes (11 per rank, multi-threaded push/pull)',
        'compare_files': [],
        'timeout': 120,
    },
    'split_eddies_1to3': {
