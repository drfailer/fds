...
! Check I_MAX_TEMP bounds

IF (I_MAX_TEMP > MAX_I_MAX_TEMP) CALL SHUTDOWN('ERROR: I_MAX_TEMP exceeds MAX_I_MAX_TEMP')
...
IF (N_TOTAL_SCALARS > MAX_SPECIES) CALL SHUTDOWN('ERROR: N_TOTAL_SCALARS exceeds MAX_SPECIES')
