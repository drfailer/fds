...
PREFORK_IF: IF (PHASE_VAL == 0 .OR. PHASE_VAL == 1) THEN
   ...
   IF (CC_IBM) THEN
      IF (PHASE_VAL == 0) CALL CC_VELOCITY_FLUX(M,DT,PREDICTOR,RHOP,CORRECT_GRAV=.FALSE.)
   ENDIF
...
LATE_IF: IF (PHASE_VAL == 0 .OR. PHASE_VAL == 3) THEN
   ...
   IF (PHASE_VAL == 3) THEN
      ...
      IF (.NOT.CONSTANT_SPECIFIC_HEAT_RATIO) THEN
         R_H_G => WK9
      ENDIF
      IF (CC_IBM) CALL CC_VELOCITY_FLUX(M,DT,PREDICTOR,RHOP,CORRECT_GRAV=.FALSE.)
   ENDIF
...
IF (CC_IBM) THEN
   DO K=1,M%KBAR
      ...
      ENDDO
   ENDDO
   CALL GET_LINKED_VELOCITIES(M,NM,CORRECTOR,CMP_FLG=.FALSE.)
ENDIF
