...
PUBLIC ASSIGN_FILE_NAMES,INITIALIZE_GLOBAL_DUMPS,INITIALIZE_MESH_DUMPS,WRITE_STATUS_FILES, &
       ...
       UPDATE_DEVICES_1_TS,UPDATE_HRR_MASS
...
MASS_DT(0:N_SPECIES+N_TRACKED_SPECIES) = MASS_DT(0:N_SPECIES+N_TRACKED_SPECIES) &
   + DT*MASS_INTEGRAL(0:N_SPECIES+N_TRACKED_SPECIES)
