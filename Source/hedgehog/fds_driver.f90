...
INTEGER :: NM,NOM,II,JJ,KK,LL,LLL,RNODE,SNODE,IMIN,IMAX,JMIN,JMAX,KMIN,KMAX,IJK_SIZE,RC,IC,LC
...
IF (N_MPI_PROCESSES>1 .AND. N_REQ>0) THEN
   ...
   END SELECT
   CALL TIMEOUT_DRIVER(ERR_STRING,N_REQ,REQ(1:N_REQ))
   N_REQ = 0
ENDIF
...
INTEGER, INTENT(IN) :: CODE
REAL(EB), INTENT(IN) :: T, DT
INTEGER :: NM,RNODE,SNODE,IJK_SIZE,NRA,NRA_MAX,LL,AIC,NN,NOM
REAL(EB) :: TNOW
