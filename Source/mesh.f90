...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: WORK1_B,WORK2_B,WORK3_B,WORK4_B,WORK5_B,WORK6_B,WORK7_B,WORK8_B,WORK9_B
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: SWORK1_B
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: SWORK2_B
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: SWORK3_B
   ...
   LOGICAL :: PREDICTOR = .FALSE.
   LOGICAL :: CORRECTOR = .TRUE.
   ...
   REAL(EB) :: BC_CLOCK
   REAL(EB), ALLOCATABLE, DIMENSION(:)   :: UN_WALLS_NOGRADH
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: U_STORE_CC,V_STORE_CC,W_STORE_CC
