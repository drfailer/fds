...
THREAD_ID = MY_RANK*N_MPI_PROCESSES
!$ IF (OMP_IN_PARALLEL()) THEN
!$     THREAD_ID = THREAD_ID + OMP_GET_THREAD_NUM()
!$ ENDIF

RHO_ZZ_F => SCRATCH_RHO_ZZ_F(1:N_TOTAL_SCALARS,THREAD_ID)
ZZ_GET => SCRATCH_ZZ_GET(1:N_TRACKED_SPECIES,THREAD_ID)
ZZ_GET_OTHER => SCRATCH_ZZ_GET_OTHER(1:N_TRACKED_SPECIES,THREAD_ID)
RHO_ZZ_OTHER => SCRATCH_RHO_ZZ_OTHER(1:N_TOTAL_SCALARS,THREAD_ID)
D_Z_N => SCRATCH_D_Z_N(0:I_MAX_TEMP,THREAD_ID)
