...
WALL_CELL_LOOP_0: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   CALL NEAR_SURFACE_GAS_VARIABLES_KERNEL(MESHES(NM), &
      T,SF,BC,B1,WALL_INDEX=IW)
   IF (CALL_HT_1D .AND. SF%THERMAL_BC_INDEX==THERMALLY_THICK) &
      B1%HEAT_TRANS_COEF = HEAT_TRANSFER_COEFFICIENT(MESHES(NM),T,B1%TMP_G-B1%TMP_F,SF,WALL_INDEX_IN=IW)
...
IF (N_THIN_WALL_CELLS>0 .AND. CALL_HT_1D) THEN
   THIN_WALL_CELL_LOOP_0: DO ITW=1,N_THIN_WALL_CELLS
      ...
      IF (TW%WALL_INDEX_M>0) THEN
         B1%HEAT_TRANS_COEF = HEAT_TRANSFER_COEFFICIENT(MESHES(NM),T,B1%TMP_G-B1%TMP_F,SF,WALL_INDEX_IN=TW%WALL_INDEX_M)
      ELSEIF (TW%WALL_INDEX_P>0) THEN
         B1%HEAT_TRANS_COEF = HEAT_TRANSFER_COEFFICIENT(MESHES(NM),T,B1%TMP_G-B1%TMP_F,SF,WALL_INDEX_IN=TW%WALL_INDEX_P)
      ELSE
...
WALL_INTERP_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
