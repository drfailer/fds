...
USE OPENMP_FDS, ONLY: GET_SCRATCH_ARRAY_INDEX
USE SCRATCH_ARRAYS
...
REAL(EB) :: ARO,QNET,RAMP_FACTOR,RHO_G_2,RSUM_F,PBAR_F,TSI,UN, &
            RHO_OTHER,RHO_OTHER_2,RHO_ZZ_OTHER_2,RHO_ZZ_G,RHO_ZZ_G_2, &
            DDO,PBAR_G,PBAR_OTHER,DENOM,D_Z_G,D_Z_OTHER,TMP_OTHER, &
...
REAL(EB), DIMENSION(:), POINTER :: RHO_ZZ_F, ZZ_GET, ZZ_GET_OTHER, RHO_ZZ_OTHER, D_Z_N
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: OM_ZZP
...
INTEGER :: SCRATCH_INDEX = 0

! Set scratch arrays

SCRATCH_INDEX = GET_SCRATCH_ARRAY_INDEX()
RHO_ZZ_F => SCRATCH_RHO_ZZ_F(1:N_TOTAL_SCALARS,SCRATCH_INDEX)
ZZ_GET => SCRATCH_ZZ_GET(1:N_TRACKED_SPECIES,SCRATCH_INDEX)
ZZ_GET_OTHER => SCRATCH_ZZ_GET_OTHER(1:N_TRACKED_SPECIES,SCRATCH_INDEX)
RHO_ZZ_OTHER => SCRATCH_RHO_ZZ_OTHER(1:N_TOTAL_SCALARS,SCRATCH_INDEX)
D_Z_N => SCRATCH_D_Z_N(0:I_MAX_TEMP,SCRATCH_INDEX)
