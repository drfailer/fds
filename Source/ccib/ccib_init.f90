...
USE CC_VELOCITY, ONLY: GET_LINKED_VELOCITIES, CC_VELOCITY_CUTFACES, &
                       CC_VELOCITY_BC
USE CC_DIVERGENCE, ONLY: CC_CHECK_DIVERGENCE
...
REAL(EB):: TNOW,TDEL,MIN_XS(1:3),MAX_XF(1:3)
...
DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
   CALL POINT_TO_MESH(NM)
   CALL GET_LINKED_VELOCITIES(MESHES(NM),NM,APPLY_TO_ESTIMATED_VARIABLES=.FALSE.,CMP_FLG=.TRUE.)
ENDDO
