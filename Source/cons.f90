...
REAL(EB), ALLOCATABLE, DIMENSION(:) :: RAD_Q_SLOTS   !< Per-mesh RAD_Q_SUM partials (indexed LOWER:UPPER_MESH_INDEX)
REAL(EB), ALLOCATABLE, DIMENSION(:) :: KFST4_SLOTS   !< Per-mesh KFST4_SUM partials (indexed LOWER:UPPER_MESH_INDEX)
