...
PUBLIC INITIALIZE_MESH_VARIABLES_1,INITIALIZE_MESH_VARIABLES_2,INITIALIZE_MESH_VARIABLES_3,INITIALIZE_GLOBAL_VARIABLES, &
       ...
       ADJUST_HT3D_WALL_CELLS,INITIALIZE_HT3D_WALL_CELLS,FIND_WALL_BACK_INDICES,INITIALIZE_SCRATCH_ARRAYS
...
SUBROUTINE INITIALIZE_SCRATCH_ARRAYS()
USE SCRATCH_ARRAYS

INTEGER :: N_THREADS = 0

N_THREADS = MAX(1, OPENMP_AVAILABLE_THREADS)

ALLOCATE(SCRATCH_ZZ_GET(1:N_TRACKED_SPECIES,0:N_THREADS))
ALLOCATE(SCRATCH_ZZ_GET_OTHER(1:N_TRACKED_SPECIES,0:N_THREADS))
ALLOCATE(SCRATCH_Y_ALL(N_SPECIES,0:N_THREADS))
ALLOCATE(SCRATCH_RHO_ZZ_F(1:N_TOTAL_SCALARS,0:N_THREADS))
ALLOCATE(SCRATCH_RHO_ZZ_OTHER(1:N_TOTAL_SCALARS,0:N_THREADS))
ALLOCATE(SCRATCH_D_Z_N(0:I_MAX_TEMP,0:N_THREADS))

END SUBROUTINE INITIALIZE_SCRATCH_ARRAYS
